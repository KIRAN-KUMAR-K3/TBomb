...
git clone https://github.com/KIRAN-KUMAR-K3/TBomb.git
cd TBomb
./TBomb.sh
```
...
**A:** There is no official website/app yet.The only official releases of TBomb are published in [Github](https://github.com/KIRAN-KUMAR-K3/TBomb.git) and [PyPi](https://pypi.org/project/tbomb)
##
...
<p align="right"> Last FAQ Update: 10.11.2023 </p>
